...
from Products.UWOshNursingInterviews.config import PROJECTNAME
from Products.UWOshNursingInterviews.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install UWOshNursingInterviews """
    out = StringIO()
    ...
    try:
        from Products.UWOshNursingInterviews.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.UWOshNursingInterviews.config import STYLESHEETS
    try:
        ...
        pass
    from Products.UWOshNursingInterviews.config import JAVASCRIPTS
    try:
